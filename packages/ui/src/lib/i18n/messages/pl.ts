...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.activity.unassignedTitle': 'sesje bez projektu',
  ...
  'opencodeUpdate.toast.updated.externalRestartRequired': 'Zewnętrzny interfejs CLI OpenCode został zaktualizowany. Uruchom ponownie jego nadzorcę serwera, aby użyć nowej wersji.',
