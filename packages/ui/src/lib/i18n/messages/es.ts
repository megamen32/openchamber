...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.activity.unassignedTitle": "sesiones sin proyecto",
  ...
  "opencodeUpdate.toast.updated.externalRestartRequired": "La CLI externa de OpenCode se actualizó. Reinicia el supervisor de su servidor para usar la nueva versión.",
