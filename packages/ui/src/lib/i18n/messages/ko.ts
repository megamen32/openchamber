...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.activity.unassignedTitle': '프로젝트 없는 세션',
  ...
  'opencodeUpdate.toast.updated.externalRestartRequired': '외부 OpenCode CLI가 업데이트되었습니다. 새 버전을 사용하려면 해당 서버의 관리자를 다시 시작하세요.',
