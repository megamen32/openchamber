...
export const dict = {
  ...
  'sessions.sidebar.activity.unassignedTitle': 'unassigned sessions',
  ...
  'opencodeUpdate.toast.updated.externalRestartRequired': 'The external OpenCode CLI was updated. Restart its own server supervisor to use the new version.',
